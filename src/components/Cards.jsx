    ...
    >
      ...
      <div className="footer absolute w-full h-15 left-0   bottom-0 ">
        <div className=" flex items-center justify-between px-7 mb-4 ">
          <h5>{data.fileSize}</h5>
          <span className="w-8 h-5 rounded-full flex items-centre justify-center bg-slate-600 rounded-full py-1 px-1">
            {data.close ? <IoCloseOutline /> : <MdOutlineFileDownload />}
          </span>
        </div>
